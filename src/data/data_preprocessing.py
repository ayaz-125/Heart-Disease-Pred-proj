...
def main():
    try:
        ...
        train_data = pd.read_csv('./data_fol/raw/train.csv')
        test_data = pd.read_csv('./data_fol/raw/test.csv')
        ...
        # Store the data inside data_fol/interim
        data_path = os.path.join("./data_fol", 'interim')
